...
def upgrade() -> None:
    ...
    op.create_index("ix_organizations_owner_user_id",
    ...
    op.create_table(
        ...
        sa.UniqueConstraint("org_id", "member_public_id",
    ...
    op.create_table(
        ...
        sa.Column("scenario_id", sa.String(length=80),
                  nullable=False, server_default=""),
        sa.Column("created_at", sa.BigInteger(), nullable=False),
        sa.Column("updated_at", sa.BigInteger(), nullable=False),
        sa.ForeignKeyConstraint(
        ...
        sa.UniqueConstraint("org_id", "public_id",
                            name="uq_projects_org_public_id"),
    )
    ...
    op.create_table(
        ...
        sa.Column("title", sa.String(length=200), nullable=False),
        sa.Column("subtitle", sa.String(length=500),
                  nullable=False, server_default=""),
    ...
    op.create_index("ix_project_sessions_project_id",
                    "project_sessions", ["project_id"])


def downgrade() -> None:
    op.drop_index("ix_project_sessions_project_id",
