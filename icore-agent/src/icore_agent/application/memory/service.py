    ...
    def build_memory_prompt(
        ...
        try:
            ...
            if selected:
                ...
                fact_ids = [fact.id for fact in selected if fact.id is not None]
            ...
            log.warning("user_memory_prompt_failed", user_id=user_id, error=str(exc))
            return None
    ...
    def _apply_extraction(
        ...
        *,
        ...
        if result.profile_updates:
            profile.profile = policy.merge_profile(profile.profile, result.profile_updates)
            log.info(
