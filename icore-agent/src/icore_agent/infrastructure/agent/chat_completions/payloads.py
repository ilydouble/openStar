"""Helpers for normalizing Chat Completions tool payloads."""
...
def result_text(result: dict[str, Any]) -> str | None:
    """Extract text from a normalized tool result payload."""
