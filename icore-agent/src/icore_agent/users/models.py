...
class User(Base):
    ...
    plan_label: Mapped[str] = mapped_column(String(80), nullable=False, default="Free")
    ...
    roles: Mapped[list[Any]] = mapped_column(JsonObject, nullable=False, default=list)
    byok: Mapped[dict[str, Any]] = mapped_column(JsonObject, nullable=False, default=dict)
    usage: Mapped[dict[str, Any]] = mapped_column(JsonObject, nullable=False, default=dict)
