...
from icore_agent.application.agent.sequential.agent import _CMD_PATTERN, SequentialAgent, SequentialResult
from icore_agent.application.agent.sequential.environment import BaseEnvironment, LocalEnvironment
...
@patch("icore_agent.application.agent.sequential.agent.completion")
