...
@patch("icore_agent.api.agent.handlers.transcribe.prepare_audio_for_zai_asr")
@patch("icore_agent.api.agent.handlers.transcribe._zai_transcribe", new_callable=AsyncMock)
...
@patch("icore_agent.api.agent.handlers.transcribe.settings")
def test_zai_transcribe_url_uses_configured_base(mock_settings):
    from icore_agent.api.agent.handlers.transcribe import _zai_transcribe_url
...
async def test_zai_transcribe_calls_glm_asr_endpoint(mock_settings):
    from icore_agent.api.agent.handlers.transcribe import _zai_transcribe
    ...
    with patch("icore_agent.api.agent.handlers.transcribe.httpx.AsyncClient") as mock_client_cls:
