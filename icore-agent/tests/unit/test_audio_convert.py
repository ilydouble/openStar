...
from icore_agent.shared.audio_convert import (
...
@patch("icore_agent.shared.audio_convert._convert_to_wav_with_ffmpeg")
...
@patch("icore_agent.shared.audio_convert.shutil.which", return_value=None)
...
@patch("icore_agent.shared.audio_convert.shutil.which", return_value="/usr/bin/ffmpeg")
@patch("icore_agent.shared.audio_convert.subprocess.run")
